#########################
# Version: 3
# Changes on v2 include:
# - Font sizes of title, ylabel, tick labels adjusted
# - x-axis (bottom spine) set set_visible
# - Linewidth (of line chart) reduced for visual balance
#########################
...
plt.figure(dpi=200)
plt.plot(dates, rec_hi['Data_Value'], color='r',
         label = 'Max for 2005-2014 ', zorder=0,
        linewidth = 0.5)
plt.plot(dates, rec_lo['Data_Value'], color='b',
         label = 'Min for 2005-2014', zorder=0,
        linewidth = 0.5)
...
plt.ylabel('In tenth of degrees C', fontsize=6)
plt.title('New low temperatures observed in 2015 \nfor Ann Arbor, Michigan',
         fontsize=8)
